...
select top 1  sp.id,ms.id,kd.id,sz.id,de.id,'CTSP2','Hoang',30,40000,'hang tot',2  from SANPHAM sp,MAUSAC ms,KIEUDANG kd, SIZE sz,DEGIAY de where sp.Masp='SP02' AND ms.Mamau='MM2' AND kd.Makieu= 'MK2'and sz.Masize = 'MS2'AND de.Made = 'MD02'
